...
public class PetDAO extends Connexio {
    ...
    public ArrayList<Pet> ObtenirClients(String codi_id) throws Exception {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                p.setData_naixment(resultSet.getDate("data_naixement"));
                p.setChip(resultSet.getString("chip"));
    ...
    public boolean insertPet(Pet p) throws SQLException, Exception {
        ...
        try {
            ...
            ps.setDate(3, p.getData_naixment());
            ps.setString(4, p.getChip());
    ...
    public boolean updatePet(Pet p) throws SQLException {
        ...
        try {
            ...
            ps.setDate(2, p.getData_naixment());
            ps.setString(3, p.getChip());
